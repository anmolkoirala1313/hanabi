...
@section('title') Success Trail @endsection
@section('css')
...
@section('content')
    ...
    <div class="page-content">
        <div class="container-fluid" style="position:relative;">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Success Trail</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Success Trail</li>
                            </ol>
                        </div>
            ...
            {!! Form::open(['route' => 'success_trail.store','method'=>'post','class'=>'needs-validation','novalidate'=>'','enctype'=>'multipart/form-data']) !!}
            <div class="row">
                <div class="col-md-8">
                    <div class="card ctm-border-radius shadow-sm grow flex-fill">
                        <div class="card-header">
                            <h4 class="card-title mb-0">
                                Success Trail details
                            </h4>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <div class="table-responsive  mt-3 mb-1">
                                    <table id="client-index" class="table align-middle table-nowrap table-striped">
                                        ...
                                        <tbody id="blog-list">
                                        @if(@$success)
                                            @foreach($success as  $trail)
                                                <tr>
                                                    <td class="align-middle pt-6 pb-4 px-6">
                                                        <img src="{{asset('/images/success_trail/'.@$trail->image)}}" alt="{{@$trail->slug}}" class="figure-img rounded avatar-lg">

                                                    </td>
                                                    <td>{{ $trail->title ?? "Not Set"}}</td>
                                                    <td>
                                                        @if(!empty($trail->country))
                                                            @foreach ($countries as $key=>$value)
                                                                @if($trail->country == $key)
                                                                    {{ $value }}
                                                               @endif
                                                            @endforeach
                                                        @endif
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-center dropdown">
                                                                ...
                                                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink2">
                                                                    <li><a class="dropdown-item action-edit" href="#" hrm-update-action="{{route('success_trail.update',$trail->id)}}" hrm-edit-action="{{route('success_trail.edit',$trail->id)}}"><i class="ri-pencil-fill me-2 align-middle"></i>Edit</a></li>
                                                                    <li><a class="dropdown-item action-delete" cs-delete-route="{{route('success_trail.destroy',$trail->id)}}"><i class="ri-delete-bin-6-line me-2 align-middle"></i>Delete</a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </td>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content border-0">
                <div class="modal-header p-3 ps-4 bg-soft-success">
                    <h5 class="modal-title" id="myModalLabel">Success Trail details</h5>
            ...
            $(document).on('click', '.action-edit', function (e) {
                ...
                $.ajax({
                    ...
                    success: function (dataResult) {
                        ...
                        $('#current-edit-img').attr("src", '/images/success_trail/' + dataResult.edit.image);
